...
const rawSafetyApiUrl = process.env.EXPO_PUBLIC_SAFETY_API_URL ?? 'http://localhost:3002';
const isLocalSafety = rawSafetyApiUrl.includes('localhost') || rawSafetyApiUrl.includes('127.0.0.1');
const safetyApiUrl =
